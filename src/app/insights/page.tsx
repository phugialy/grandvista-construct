    ...
    <MarketingShell>
      ...
      <section className="section-shell py-20">
        <div className="flex flex-col justify-between gap-6 lg:flex-row lg:items-end">
          <div>
            <p className="eyebrow">Commercial Notes</p>
            ...
            <p className="mt-5 max-w-2xl leading-7 text-steel">
              The best articles should help owners, operators, architects, and project teams
        ...
        {posts.length > 0 ? (
          ...
          <div className="mt-12 border border-ink/12 bg-white p-8">
            ...
            <h3 className="mt-4 text-3xl font-black leading-tight">
              Insights will appear here once posts are published.
            </h3>
