  ...
  return (
    <main className="min-h-screen bg-warm-white text-ink">
      <section className="section-shell py-10">
        <div className="flex flex-col justify-between gap-6 border-b border-ink/10 pb-8 md:flex-row md:items-end">
          <div>
          ...
          <form action={logoutAdmin}>
            <button className="border border-ink/20 px-5 py-3 text-sm font-black uppercase tracking-[0.08em] text-ink hover:border-brand-red hover:text-brand-red">
              Log Out
            </button>
          </form>
        </div>
